...
trait TestUploads
{
    protected function assertInvalidationFile($field, $extension, $maxSize, $rule, $ruleParams = []): void
    {
        $routes = [
            [
                'method' => 'POST',
    ...
    protected function assertFilesExistsInStorage($model, array $files): void
    {
        /** @var \App\Models\Traits\UploadFiles $file */
